    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center relative pt-10">
            ...
            <Swiper
                ...
                style={{ height: '80%', width: '90%', margin: 0 }}
                freeMode={false}
            >
                <SwiperSlide>
                ...
                {/* 화살표 추가 */}
                <div className="swiper-button-next" style={{ color: 'white', height:'20%' }}></div>
                <div className="swiper-button-prev" style={{ color: 'white', height:'20%' }}></div>
            </Swiper>
            <style>
                {`
