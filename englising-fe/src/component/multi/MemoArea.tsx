...
function MemoArea() {
  ...
  return (
    <div className="bg-primary-400 mt-4 py-2 px-4 rounded-lg">
      ...
      <textarea
        className="w-full max-h-24 mt-2 bg-transparent resize-none overflow-hidden text-lg placeholder:text-gray-300 placeholder:text-center placeholder:text-sm focus:outline-none"
