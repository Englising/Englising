...
const SearchResultPage: React.FC = () => {
    ...
    const [selectedMusic, setSelectedMusic] = useState<SelectedMusic>({
        trackId: 0,
        trackTitle: "",
        artists: "",
        albumImg: "",
    ...
    const handleClickButton = (index: number): void => {
        setSelectedMusic({
            ...
            artists: searchedMusic[index].artists,
            albumImg: searchedMusic[index].albumImg,
            youtubeId: searchedMusic[index].youtubeId,
        });
    };
            ...
            <div className='flex flex-col pt-10 pl-8 '>
                ...
                <div className='pt-5 flex flex-row h-5/6'>
                    ...
                    <div className='pl-14 w-4/5'>
                        <h1 className=' text-white font-bold text-xl w-60 pb-3'>'{searchTerm}' 검색 결과</h1>
                        ...
                        <div className="relative flex flex-col overflow-y-auto h-full scrollbar-webkit">
                            <div className='text-white grid grid-cols-3 gap-4 justify-items-start '>
                                {searchedMusic && searchedMusic.length > 0 ? (
                                    ...
                                    <div className="text-white w-48">검색 결과가 없습니다.</div>
                                )}
                            </div>
                        </div>
                    </div>
